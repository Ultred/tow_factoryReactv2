    ...
    return (
      <>
       ...
       {step === 3 && (
        ...
        <Button buttonStyle={"primary"} type={"button"} onClick={handleNextClick}>
  ...
  return (
    ...
    {!registrationSuccess && (
      <div className={styles.container}>
        <div className={styles.imgRight}>
          <img className={styles.imgLoginPic} src="/src/assets/loginPic.png" alt="" />
        </div>
        <form className={styles.formRight}>
          <img className={styles.imgLoginLogo} src="/src/assets/towfactoryLogo.svg" alt="Tow Factory" />
          {renderForm()}
    ...
    {registrationSuccess && (
      <div className={styles.successPage}>
        <img className={styles.imgSuccessLogo} src="/src/assets/Frame 4000.png" alt="" />
        <div className={styles.regSuccess}>
            <h2>Registered!</h2>
            <h3>You are now ready to tow your vehicle!</h3>
        </div>
          <Button buttonStyle={"tertiary"} type={"submit"} onClick={handleDashboard}>
